...
if ispc, ren = 'ren'; % matlab movefile is too slow
else ren = 'mv';
end

flds = {'InstanceNumber' 'AcquisitionNumber' 'SeriesNumber' 'EchoNumber' ...
        'ProtocolName' 'PatientName' 'PatientID' 'Manufacturer'};
dict = dicm_dict('', flds);
